...
const val SIGN_UP_BATTERY_OPTIMIZATION_TITLE = "주사/약 알림을 위해\n백그라운드 실행 허용이 필요해요"
const val SIGN_UP_BATTERY_OPTIMIZATION_CONTENT = "다음 버튼을 누른 후 나오는 설정창에서\n‘허용'을 눌러야 주사/약 알림을 사용할 수 있어요"
